...
class I18n:
    ...
    def create_default_translations(self, translations_dir):
        ...
        zh_translations = {
            ...
            'owner_label': 'GitHub 用户名/组织名',
            'owner_placeholder': '例如：microsoft',
            'repo_label': '仓库名称',
            'repo_placeholder': '例如：vscode',
            'analyze_button': '开始分析',
            'analyzing': '正在分析中，请稍候...',
            'error_invalid_params': '请输入有效的用户名和仓库名',
        ...
        en_translations = {
            ...
            'owner_label': 'GitHub Username/Organization',
            'owner_placeholder': 'e.g.: microsoft',
            'repo_label': 'Repository Name',
            'repo_placeholder': 'e.g.: vscode',
            'analyze_button': 'Start Analysis',
            'analyzing': 'Analyzing, please wait...',
            'error_invalid_params': 'Please enter a valid username and repository name',
